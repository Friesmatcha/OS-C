...
CORE_SOURCES := src/core/FileSystemService.cpp src/core/PathResolver.cpp src/persistence/JsonRepository.cpp
TEST_SOURCES := tests/FileSystemTests.cpp src/cli/CommandParser.cpp $(CORE_SOURCES)
